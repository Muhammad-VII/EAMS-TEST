...
import { PersonImgComponent } from './person-img/person-img.component';
...
export class HeadComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['actions', 'status', 'icon', 'name', 'title', 'model'];
  ...
  constructor(
    public dialogRef: MatDialogRef<HeadComponent>,
