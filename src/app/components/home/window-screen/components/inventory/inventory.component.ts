...
export class InventoryComponent implements OnInit {
  ...
  constructor(
    ...
    this.componentInfo = this._ShowComponentsService.componentsData
      const filterdComponent:any = this.componentInfo.filter(ele => ele.Name == 'Inventory');
  ...
  focus(e:any) {
    ...
    $("#Asset, #Education, #IT, #Delivery, #BI, #Banks, #Controller, #E-Commerce, #Finance, #Fleet, #GPS, #HR").removeClass("large_Index")
  }
  minimize(e:any) {
