...
export class IdentityComponent implements OnInit {
  ...
  displayedColumns: string[] = ['actions', 'status', 'photo', 'id', 'type', 'firstName', 'lastName', 'email', 'expiration'];
  dataSource!: MatTableDataSource<UserData>;
  openAddDialog(): void {
    this._Dialog.open(AddIdentityComponent, {
      hasBackdrop: false
    })
  }
  ...
  constructor(
    public dialogRef: MatDialogRef<IdentityComponent>,
    ...
    const filterdComponent:any = this.componentInfo.filter(ele => ele.Name == 'Banks')
  ...
  focus(e:any) {
    ...
    $("#Asset, #Education, #IT, #Delivery, #BI, #CRM, #Controller, #E-Commerce, #Finance, #Fleet, #GPS, #HR, #Inventory").removeClass("large_Index")
  }
  minimize(e:any) {
