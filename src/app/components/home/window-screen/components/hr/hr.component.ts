...
export class HrComponent implements OnInit {
  ...
  focus(e:any) {
    ...
    $("#Asset, #Education, #IT, #Delivery, #BI, #Banks, #Controller, #E-Commerce, #Finance, #Fleet, #GPS, #Inventory").removeClass("large_Index")
  }
  minimize(e:any) {
