...
export class DeliveryComponent implements OnInit {
  ...
  constructor(
    ...
    const filterdComponent:any = this.componentInfo.filter(ele => ele.Name == 'Delivery');
  ...
  focus(e:any) {
    ...
    $("#Asset, #Education, #IT, #BI, #Banks, #Controller, #E-Commerce, #Finance, #Fleet, #GPS, #HR, #Inventory").removeClass("large_Index")
  }
  minimize(e:any) {
