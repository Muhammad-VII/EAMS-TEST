...
@Component({
  selector: 'app-add-civil',
  templateUrl: './add-civil.component.html',
  styleUrls: ['./add-civil.component.scss']
})
export class AddCivilComponent implements OnInit {
  isEditable = false;
  switchValue = false;
  ...
  constructor(private MatDialogRef: MatDialogRef<AddCivilComponent>) {}
  loading = false;
  avatarUrl?: string;
  beforeUpload = (
    file: NzUploadFile,
