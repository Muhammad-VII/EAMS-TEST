...
import { AddCivilComponent } from './add-civil/add-civil.component';
...
export class CivilComponent implements OnInit {
  ...
  displayedColumns: string[] = ['actions', 'status', 'name', 'police', 'city'];
  dataSource!: MatTableDataSource<UserData>;
  openAddDialog(): void {
    this._Dialog.open(AddCivilComponent, {
      hasBackdrop: false,
    });
  }
  ...
  constructor(
    public dialogRef: MatDialogRef<CivilComponent>,
