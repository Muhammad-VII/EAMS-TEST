...
import { UserImgComponent } from '../window-screen/components/users/user-img/user-img.component';
import { AddUserComponent } from '../window-screen/components/users/add-user/add-user.component';
import { UsersComponent } from '../window-screen/components/users/users.component';
import { UserDetailsComponent } from '../window-screen/components/user-details/user-details.component';
declare const $: any;
